...
PROG_TITLE="Tax Calculator 2018"

# The name of the config file
CONFIG_FILE=".tk_tax2.ini"
...
STD_DEDUCTION_M = 24000
FED_TAX_LIMITS_M = [ 19050, 77400, 165000, 315000, 400000, 600000, 10000000000 ]

STD_DEDUCTION_S = 12000
FED_TAX_LIMITS_S = [ 9525, 38700, 82500, 157500, 200000, 500000, 10000000000 ]
...
#Fields
fields = ['Annual Income', 'Health Insurance', '401K Contribution', 'Number of Children', 'Federal Tax','Social Security Tax','Medicare Tax', 'Take Home Pay']
field_values = {}
...
def get_fed_tax(total_income, insurance, k401, num_children):
   if FILE_TYPE == 1:
   ...
   fed_taxable = total_income - insurance - k401 - STD_DEDUCTION
   #print "%d %d %d %d %d" %(total_income, insurance, k401, STD_DEDUCTION, fed_taxable)
   ...
   for i in range(0, num_bracket):
     if fed_taxable < FED_TAX_LIMITS[i]:
       ...
       return fed_tax - CHILD_CREDIT *num_children
     else:
...
class MainWindow(Frame):
  ...
  def calc_tax(self, *args):
    ...
    fed_tax = get_fed_tax(total_income, insurance, k401, num_children)
